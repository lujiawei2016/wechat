...
<link href="${ctx}/static/binding/css/style.css" rel='stylesheet' type='text/css' />
<!--webfonts-->
<!--//webfonts-->
<script type="text/javascript" src="${ctx}/static/jquery/jquery-2.1.4.min.js"></script>
<script type="text/javascript" src="${ctx}/static/binding/js/binding.js"></script>
...
<div class="login-form">
	<div class="close"> </div>
		<div class="head-info">
			...
			<div class="clear"> </div>
	<div class="avtar">
		<img src="${ctx}/static/binding/images/avtar.png" />
	</div>
			<form>
